...
// The 4 office bearers reused (slugs match TEAM)
{
  ...
  talks: [{
    event: 'Nullcon Goa',
    year: 2024,
    title: 'How we got domain admin in 11 minutes'
  }, {
    event: 'BSides Bangalore',
    year: 2024,
    title: 'Adversary emulation, properly scoped'
  }, {
    event: 'OWASP Bangalore',
    year: 2025,
    title: 'The pen test report nobody reads'
  }],
  projects: [{
    name: 'kerb-roast',
    desc: 'Faster Kerberoasting with smarter wordlist seeding',
    stars: '1.4k',
    lang: 'Go'
  }, {
    name: 'redteam-notes',
    desc: 'Public playbook for scoped red team engagements',
    stars: '780',
    lang: 'Markdown'
  }]
}, {
  ...
  talks: [{
    ...
    year: 2024,
    title: "Auth that doesn't leak"
  }, {
    event: 'KubeCon EU',
    year: 2025,
    title: 'CKS, but for real systems'
  }],
  projects: [{
    name: 'm-dash',
    desc: 'Self-hosted internal tooling, n8n + Appsmith stitched right',
    stars: '4.2k',
    lang: 'TypeScript'
  }, {
    name: 'verifyjwt-tiny',
    desc: '1.2KB JWT verifier with timing-safe defaults',
    stars: '910',
    lang: 'TypeScript'
  }]
}, {
  ...
  talks: [{
    event: 'IIT Hyderabad',
    year: 2025,
    title: 'Teaching offense before defense'
  }, {
    event: 'BITS Goa',
    year: 2024,
    title: 'Why your CTF infra always falls over'
  }],
  projects: [{
    name: 'ctf-loadgen',
    desc: 'Load-test your CTF before 800 students log in at once',
    stars: '620',
    lang: 'Python'
  }]
}, {
  ...
  talks: [{
    event: 'TiE Bangalore',
    year: 2025,
    title: 'Bootstrapping a security firm in India'
  }],
  projects: []
},
// Guest contributors
{
  ...
  name: 'Noor Rashid',
  vertical: 'security',
  role: 'Guest · Independent researcher',
  ...
  talks: [{
    event: 'Nullcon Goa',
    year: 2025,
    title: 'React-to-shell: a chain of three nothings'
  }],
  projects: [{
    name: 'react2shell',
    desc: 'PoC + writeup for CVE-2025-XXXXX',
    stars: '2.1k',
    lang: 'JavaScript'
  }]
}, {
...
{
  id: 'react2shell-cve',
  title: "React2Shell: chaining three nothings into a remote shell",
  ...
  format: 'technical',
  category: 'security',
  tags: ['CVE', 'RCE', 'React', 'SSR', 'Writeup'],
  author: 'noor-rashid',
  coAuthors: ['aarav-mehta'],
  date: '2026-04-22',
  readMin: 14,
  hue: 'security',
  featured: true,
  ...
  id: 'cve-digest-2026-w17',
  title: "Weekly CVE digest: week 17, 2026",
  deck: "Eleven CVEs worth your Monday. The Cisco IOS one is the only urgent patch — here's why.",
  format: 'listicle',
  category: 'security',
  tags: ['CVE', 'Digest', 'Weekly'],
  author: 'aarav-mehta',
  date: '2026-04-27',
  readMin: 6,
  hue: 'security',
  coverShape: 'grid',
  pull: "Eleven CVEs. One emergency. The rest are noise dressed up as news."
}, {
  id: 'red-team-fintech',
  title: "Anonymised: how we got domain admin at a Series C fintech",
  deck: "Four-week red team engagement. Initial access through a vendor laptop. Eleven minutes from foothold to DA.",
  format: 'launch',
  category: 'security',
  tags: ['Red Team', 'Case Study', 'Fintech'],
  author: 'aarav-mehta',
  date: '2026-03-14',
  readMin: 11,
  hue: 'security',
  coverShape: 'lock',
  pull: "The vendor laptop wasn't in the SOW. It was the entire engagement."
}, {
  id: 'dpdpa-readiness',
  title: "DPDPA in practice: what your security team actually needs to do",
  deck: "Stripping the regulation back to the technical controls and the documentation that proves them.",
  format: 'technical',
  category: 'security',
  tags: ['DPDPA', 'Compliance', 'India'],
  author: 'sana-kapoor',
  date: '2026-02-08',
  readMin: 9,
  hue: 'security',
  coverShape: 'shield',
  pull: "Compliance is just security with a paper trail. Both should be the same project."
},
// ── Software shelf ───────────────────────────────
{
  id: 'm-dash-launch',
  title: "Introducing M-Dash: n8n + Appsmith, stitched right",
  deck: "We got tired of internal tools that lock you in. M-Dash is what we built for ourselves — and now we're shipping it.",
  format: 'launch',
  category: 'software',
  tags: ['Product', 'Launch', 'Open Source'],
  author: 'priya-iyer',
  coAuthors: ['rohan-das'],
  date: '2026-04-30',
  readMin: 8,
  ...
  featured: true,
  coverShape: 'editor',
  pull: "Internal tools are the dark matter of every company. We made ours visible.",
  series: null
}, {
  id: 'auth-that-doesnt-leak',
  title: "Auth that doesn't leak: a checklist that actually fits on one screen",
  deck: "Twelve things every login flow should do, ranked by how often we see them missing on engagements.",
  format: 'listicle',
  category: 'software',
  tags: ['Auth', 'Tutorial', 'Checklist'],
  author: 'priya-iyer',
  date: '2026-04-02',
  readMin: 7,
  hue: 'software',
  coverShape: 'editor',
  pull: "Half of all auth bugs are the same three patterns. The other half wear different hats."
}, {
  id: 'shipping-fast-without-leaking',
  title: "Shipping fast without leaking: a tutorial in pre-commit hooks",
  deck: "A 30-minute setup that catches secrets, vulnerable deps, and IaC drift before they hit your remote.",
  format: 'technical',
  category: 'software',
  tags: ['Tutorial', 'DevSecOps', 'Pre-commit'],
  author: 'priya-iyer',
  date: '2026-01-27',
  readMin: 12,
  hue: 'software',
  coverShape: 'editor',
  pull: "The cheapest place to fix a leak is on a developer's laptop, before they hit enter."
},
// ── Education shelf ──────────────────────────────
{
  id: 'nullcon-2026-recap',
  title: "Nullcon 2026 — the recap, with photos",
  deck: "We powered the village this year. Here's what 800 attendees, 14 talks, and one accidental power outage looked like.",
  format: 'event',
  category: 'education',
  tags: ['Event', 'Conference', 'Photos'],
  author: 'rohan-das',
  coAuthors: ['sana-kapoor'],
  date: '2026-03-30',
  readMin: 10,
  hue: 'education',
  featured: true,
  coverShape: 'badge',
  pull: "Conferences are infrastructure. Treat them that way.",
  series: 'NullCon · powered by Destro Sec'
}, {
  id: 'ctf-cohort-08',
  title: "Cohort 08 capstone CTF: the writeup",
  deck: "Four teams, one weekend, and a deliberately broken Active Directory. Here's what they found and what they missed.",
  format: 'event',
  category: 'education',
  tags: ['CTF', 'Writeup', 'Cohort'],
  author: 'rohan-das',
  date: '2026-04-12',
  readMin: 13,
  hue: 'education',
  coverShape: 'badge',
  pull: "Every cohort fails the same way until we change the curriculum. Then they fail in new ways."
}, {
  id: 'learning-offense-from-zero',
  title: "Learning offense from zero: month one as a Cohort 06 student",
  deck: "An honest log of what worked, what broke, and what I wished someone had told me before I joined.",
  format: 'technical',
  category: 'education',
  tags: ['Student', 'Diary', 'Beginner'],
  author: 'devansh-rai',
  date: '2026-02-19',
  readMin: 9,
  hue: 'education',
  coverShape: 'badge',
  pull: "The hardest part of learning offense isn't the tools. It's the patience to read three layers down."
},
// ── Opinion / fundraise / company ────────────────
{
  id: 'fundraise-2026',
  title: "We're raising. Here's what we'll spend it on (and what we won't).",
  deck: "Three years bootstrapped. Now we're raising a small seed to grow education without compromising the work.",
  format: 'manifesto',
  category: 'company',
  tags: ['Company', 'Fundraise', 'Manifesto'],
  author: 'sana-kapoor',
  coAuthors: ['aarav-mehta'],
  date: '2026-04-25',
  readMin: 5,
  ...
  featured: true,
  coverShape: 'flag',
  pull: "Most security firms scale by hiring juniors and selling them as seniors. We'd rather not.",
  sponsor: true
}, {
  id: 'reports-no-one-reads',
  title: "Stop writing reports nobody reads",
  deck: "A short, opinionated piece about why the 200-page CVSS PDF is a tax on your client and a waste of your team's talent.",
  format: 'manifesto',
  category: 'company',
  tags: ['Opinion', 'Reporting', 'Craft'],
  author: 'aarav-mehta',
  date: '2026-03-02',
  readMin: 4,
  hue: 'opinion',
  coverShape: 'flag',
  pull: "If the dev who has to fix the bug can't read the finding without three Google searches, the finding is broken."
}];
