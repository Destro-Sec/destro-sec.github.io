    ...
    case 'services':
      {
        ...
        const vData = {
          security: VERTICAL_DATA.security,
          software: VERTICAL_DATA.software,
          education: VERTICAL_DATA.education
        };
        const vDescMap = {
        ...
        return {
          ...
          schema: breadcrumb([[SITE_NAME, base], ['Services', `${base}/services`], ...(v ? [[vData[v]?.name || v, url]] : [])])
        };
      }
    case 'about':
      return {
    ...
    case 'contact':
      return {
        ...
        schema: [{
          ...
          mainEntity: [{
            '@type': 'Question',
            name: 'Do you work with teams outside India?',
            acceptedAnswer: {
              '@type': 'Answer',
              text: "Yes. About 30% of our work is with Nordic, SE Asia, and US teams. Remote-first since day one."
            }
          }, {
            '@type': 'Question',
            name: 'Can you sign our NDA before scoping?',
            acceptedAnswer: {
              '@type': 'Answer',
              text: "Of course. We sign first, scope second. Send it on the contact form or to legal@destrosec.com."
            }
          }, {
            '@type': 'Question',
            ...
            acceptedAnswer: {
              '@type': 'Answer',
              text: "Pen tests start around ₹3L for a focused web app. Red teams from ₹15L. Software builds quoted by sprint. Education engagements are bespoke."
            }
          }, {
            '@type': 'Question',
            name: 'Do you offer retainers or just one-off work?',
            acceptedAnswer: {
              '@type': 'Answer',
              text: "Both. Retainers come with a real human number on-call and quarterly threat-model reviews."
            }
          }, {
            '@type': 'Question',
            name: "I'm a student — can I learn from you for free?",
            acceptedAnswer: {
              '@type': 'Answer',
              text: "Yes. Our community CTFs are free, and we run scholarships for the bootcamp."
            }
          }]
...
function urlFor(page, params = {}) {
  switch (page) {
    case 'home':
      return '/';
    case 'services':
      return params.vertical ? `/services/${params.vertical}` : '/services';
    case 'about':
      return '/about';
    case 'team':
      return params.id ? `/team/${params.id}` : '/team';
    case 'contact':
      return '/contact';
    case 'quote':
      return params.vertical ? `/quote/${params.vertical}` : '/quote';
    case 'blog':
      return '/blog';
    case 'blog-post':
      return params.id ? `/blog/${params.id}` : '/blog';
    case 'blog-author':
      return params.id ? `/blog/author/${params.id}` : '/blog';
    default:
      return '/';
  }
}
...
function App() {
  ...
  switch (route.page) {
    case 'home':
      pageEl = /*#__PURE__*/React.createElement(HomePage, {
        onNav: onNav,
        tweaks: tweaks
      });
      break;
    case 'services':
      pageEl = /*#__PURE__*/React.createElement(ServicesPage, {
        onNav: onNav,
        initialVertical: route.params.vertical,
        tweaks: tweaks
      });
      break;
    case 'about':
      pageEl = /*#__PURE__*/React.createElement(AboutPage, {
        onNav: onNav
      });
      break;
    case 'team':
      pageEl = /*#__PURE__*/React.createElement(TeamProfilePage, {
        onNav: onNav,
        memberId: route.params.id
      });
      break;
    case 'contact':
      pageEl = /*#__PURE__*/React.createElement(ContactPage, {
        onNav: onNav
      });
      break;
    case 'quote':
      pageEl = /*#__PURE__*/React.createElement(QuotePage, {
        onNav: onNav,
        initialVertical: route.params.vertical
      });
      break;
    case 'blog':
      pageEl = /*#__PURE__*/React.createElement(BlogHomePage, {
        onNav: onNav
      });
      break;
    case 'blog-post':
      pageEl = /*#__PURE__*/React.createElement(BlogPostPage, {
        onNav: onNav,
        postId: route.params.id
      });
      break;
    case 'blog-author':
      pageEl = /*#__PURE__*/React.createElement(BlogAuthorPage, {
        onNav: onNav,
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(Nav, {
    ...
    id: "main-content",
    key: route.page + (route.params.id || route.params.vertical || '')
    ...
    label: "Post \xB7 Technical",
    onClick: () => onNav('blog-post', {
      id: 'react2shell-cve'
    })
  }), /*#__PURE__*/React.createElement(TweakButton, {
    label: "Post \xB7 Launch",
    onClick: () => onNav('blog-post', {
      id: 'm-dash-launch'
    })
  }), /*#__PURE__*/React.createElement(TweakButton, {
    label: "Post \xB7 Event",
    onClick: () => onNav('blog-post', {
      id: 'nullcon-2026-recap'
    })
  }), /*#__PURE__*/React.createElement(TweakButton, {
    label: "Post \xB7 Manifesto",
    onClick: () => onNav('blog-post', {
      id: 'fundraise-2026'
    })
  }), /*#__PURE__*/React.createElement(TweakButton, {
