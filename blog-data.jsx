...
const BLOG_AUTHORS = [
  ...
  { id: 'rohan-das', type: 'core',  name: 'Rohan Das', vertical: 'education', role: 'Head of Education',
  ...
  { id: 'sana-kapoor',  type: 'core',  name: 'Sana Kapoor',  vertical: 'security', role: 'Head of Operations',
    ...
    pronouns: 'she/her', location: 'Bangalore, IN', joined: '2023', site: 'sana.co',
...
const BLOG_POSTS = [
  ...
  { id: 'dpdpa-readiness', title: "DPDPA in practice: what your security team actually needs to do",
    ...
    author: 'sana-kapoor', date: '2026-02-08', readMin: 9, hue: 'security',
  ...
  { id: 'm-dash-launch', title: "Introducing M-Dash: n8n + Appsmith, stitched right",
    ...
    author: 'priya-iyer', coAuthors: ['rohan-das'],
  ...
  { id: 'nullcon-2026-recap', title: "Nullcon 2026 — the recap, with photos",
    ...
    author: 'rohan-das', coAuthors: ['sana-kapoor'],
  ...
  { id: 'ctf-cohort-08', title: "Cohort 08 capstone CTF: the writeup",
    ...
    author: 'rohan-das', date: '2026-04-12', readMin: 13, hue: 'education',
  ...
  { id: 'fundraise-2026', title: "We're raising. Here's what we'll spend it on (and what we won't).",
    ...
    author: 'sana-kapoor', coAuthors: ['aarav-mehta'],
